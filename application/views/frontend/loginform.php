...
#login-form{width:100%; margin:0 auto; background:#f8f8f8; overflow:hidden; border-radius:7px}
...
<li><label for="login"><i class="fa fa-lock"></i> Member Login</label></li>
</ul>
...
echo form_open('index/userLogin', array('class'=>'form-horizontal', 'style'=>'margin-bottom: 0px !important;')); ?>
<ul class="ul-list">
<li><input type="text" name="username" required class="input" placeholder="Your Email"/><span class="icon"><i class="fa fa-user"></i></span></li>
