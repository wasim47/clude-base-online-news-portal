            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#"><img src="<?php echo base_url();?>asset/images/mlogo.png" class="img-responsive">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-picture-o"></i>Advertisement Banage<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                ...
                                <li><a><i class="fa fa-bar-chart-o"></i>Follow Up<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    ...
                                    <li><a href="<?php echo base_url('index/logout');?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                    </li>
                                </ul>
                            </li>
